...
!(function (e, t) {
  ...
  function ea(e, t) {
    var r = t && "matrix(1, 0, 0, 1, 0, 0)" !== ba(e)[f] && xe.to(e, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
  ...
  function Ja(e, t, r, n, o, i, a, s, l, c, f, u) {
    if ((G(e) && (e = e(s)), F(e) && "max" === e.substr(0, 3) && (e = u + ("=" === e.charAt(4) ? na("0" + e.substr(3), r) : 0)), H(e))) a && T(a, r, n, f, !0);
      ...
      var p,
        ...
        v = ea(h) || {},
        m = e.split(" ");
      (v && (v.left || v.top)) || "none" !== ba(h).display || ((g = h.style.display), (h.style.display = "block"), (v = ea(h)), g ? (h.style.display = g) : h.style.removeProperty("display")),
        (p = na(m[0], v[n.d])),
        (d = na(m[1] || "0", r)),
      ...
      if (((this.progress = 0), this.vars && this.kill(1), Fe)) {
        ...
        (se *= 45),
          ...
          (!1 === ie || ie === je || (ie = "flex" !== ba(oe.parentNode).display && Re),
            ...
            (e = xe.core.getCache(oe)).spacer ? (A = e.pinState) : ((e.spacer = N = Te.createElement("div")), N.setAttribute("class", "pin-spacer" + (i ? " pin-spacer-" + i : "")), (e.pinState = A = Ga(oe))),
              ...
              if (oe && e && ze) ia(ScrollTrigger, "scrollEnd", be);
                ...
                if (
                  ((T = Ja(m, ne, f, K, me.scroll(), k, M, me, u, ve, de, p) || (oe ? -0.001 : 0)),
                    G(h) && (h = h(me)),
                    F(h) && !h.indexOf("+=") && (~h.indexOf(" ") ? (h = (F(m) ? m.split(" ")[0] : "") + h) : ((d = na(h.substr(2), f)), (h = F(m) ? m : T + d), (v = ne))),
                    (S = Math.max(T, Ja(h || (v ? "100% 0" : p), v, f, K, me.scroll() + d, _, P, me, u, ve, de, p)) || -0.001),
                    (O = S - T || ((T -= 0.01) && 0.001)),
                    oe)
                ) {
                  ...
                  if (
                    ((T += g),
                      ...
                      (B = Ga(oe)),
                      (o = ea(oe, !0)),
                      ie && ((N.style[ie + K.os2] = O + g + qe), (q = ie === Re ? fa(oe, K) + O + g : 0) && (N.style[K.d] = q + qe), de && me.scroll(t)),
                      de &&
                      (((s = { top: o.top + (a ? i - T : 0) + qe, left: o.left + (a ? 0 : i - T) + qe, boxSizing: "border-box", position: "fixed" })[Ie] = s.maxWidth = Math.ceil(o.width) + qe),
                      ...
                      x ? (x.progress(1, !0), (W = R(K.a) - j + O + g), O !== W && L.splice(L.length - 2, 2), x.progress(0, !0)) : (W = O),
                      b)
                  )
                    for (l = 0; l < b; l++) Ve[l].pin === oe && Ve[l].revert(!1);
                } else if (ne && me.scroll()) for (o = ne.parentNode; o && o !== Se;) o._pinOffset && ((T -= o._pinOffset), (S -= o._pinOffset)), (o = o.parentNode);
                (me.start = T),
                  (me.end = S),
            ...
            if ((t && ((h = g), (g = s), ce && ((Y = X), (X = x && !ue ? x.totalProgress() : c))), se && !c && oe && !Me && T < s + ((s - h) / (Oe() - _e)) * se && (c = 1e-4), c !== f && $)) {
              if (
                ((i = (a = (r = me.isActive = !!c && c < 1) != (!!f && f < 1)) || !!c != !!f),
                  ...
                  (me.progress = c),
                  ue || (!V || Me || Ee ? x && x.totalProgress(c, !!Me) : ((V.vars.totalProgress = c), V.invalidate().restart())),
                  oe)
              )
                      ...
                      !(function _reparent(e, t) {
                        if (e.parentNode !== t) {
                          var r,
                            n,
                            o = e.style;
                          if (t === Se) for (r in ((e._stOrig = o.cssText), (n = ba(e)))) +r || Qe.test(r) || !n[r] || "string" != typeof o[r] || "0" === r || (o[r] = n[r]);
                  ...
                  ? ((n = c && !f ? 0 : 1 === c ? 1 : 1 === f ? 2 : 3),
                    1 === c && le
                      ...
                      ((o = (!a && "none" !== he[n + 1] && he[n + 1]) || he[n]),
                        ...
                        Q && Q(me)),
                    (!a && Ee) || (te && a && te(me), ge[n] && ge[n](me), le && (ge[n] = 0), a || (ge[(n = 1 === c ? 1 : 3)] && ge[n](me))))
                  : ue && Q && !Me && Q(me);
            }
            J && (b(s + (M._isFlipped ? 1 : 0)), J(s));
          }),
          (me.enable = function () {
            $ || (($ = !0), ia(pe, "resize", ua), ia(pe, "scroll", ta), ye && ia(ScrollTrigger, "refreshInit", ye), x && (x.add ? xe.delayedCall(0.01, me.refresh) && (O = 0.01) && (T = S = 0) : me.refresh()));
          }),
      ...
      (ScrollTrigger.register = function register(e) {
        if (
          ((xe = e || B()),
            ...
            xe && ((Ce = xe.utils.toArray), (ke = xe.utils.clamp), xe.core.globals("ScrollTrigger", ScrollTrigger), Se))
        ) {
          (s =
