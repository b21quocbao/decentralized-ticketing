  ...
  typeof define == "function" && define.amd ? define(S) : S();
    ...
    function vn() {
        ...
        function e(u, s, a) {
            var d,
                f = !0;
            return typeof CustomEvent == "function" ? (d = new CustomEvent(s, { bubbles: f, detail: a })) : ((d = document.createEvent("CustomEvent")), d.initCustomEvent(s, f, !1, a)), u.dispatchEvent(d), d;
        }
        function o(u, s, a) {
            H(u, function (d) {
                d &&
