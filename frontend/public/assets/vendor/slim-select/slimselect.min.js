!(function (e, t) {
  ...
  class a {
    ...
    validateDataArray(e) {
      ...
      for (let t of e) {
        if (!(t instanceof i || "label" in t)) return t instanceof n || "text" in t ? this.validateOption(t) : new Error("Data object must be a valid optgroup or option");
    ...
    setSelectedBy(e, t) {
      ...
      for (let l of this.data) {
        if (l instanceof i) for (let i of l.options) s || (s = i), (i.selected = !a && t.includes(i[e])), i.selected && "single" === this.selectType && (a = !0);
        l instanceof n && (s || (s = l), (l.selected = !a && t.includes(l[e])), l.selected && "single" === this.selectType && (a = !0));
      }
  ...
  class l {
      ...
      if ((s.classList.add(this.classes.valueText), (s.innerText = e.text), t.appendChild(s), !e.mandatory)) {
        ...
        s.classList.add(this.classes.valueDelete),
          (s.onclick = (t) => {
            ...
            if (!(this.settings.minSelected && l.length < this.settings.minSelected) && (this.callbacks.beforeChange && (s = !0 === this.callbacks.beforeChange(l, a)), s)) {
              let e = [];
              for (const t of l) {
            ...
            a.appendChild(l),
              t.options.some((e) => e.selected) || "" !== this.content.search.input.value.trim()
                ...
                : "open" === t.closable
                  ...
                  : "close" === t.closable && (e.classList.add(this.classes.close), l.setAttribute("d", this.classes.arrowClose)),
              s.addEventListener("click", (t) => {
                t.preventDefault(),
                  t.stopPropagation(),
                  e.classList.contains(this.classes.close)
                    ? (e.classList.remove(this.classes.close), e.classList.add(this.classes.open), l.setAttribute("d", this.classes.arrowOpen))
                    : (e.classList.remove(this.classes.open), e.classList.add(this.classes.close), l.setAttribute("d", this.classes.arrowClose));
              }),
              n.appendChild(i);
          }
          e.appendChild(s);
    ...
    option(e) {
      ...
      return (
        ...
        this.settings.searchHighlight && "" !== this.content.search.input.value.trim()
          ? (t.innerHTML = this.highlightText("" !== e.html ? e.html : e.text, this.content.search.input.value, this.classes.searchHighlighter))
          : "" !== e.html
            ? (t.innerHTML = e.html)
        ...
        e.selected
          ? (t.classList.add(this.classes.selected), t.setAttribute("aria-selected", "true"), this.main.main.setAttribute("aria-activedescendant", t.id))
    ...
    moveContentBelow() {
      ...
      (this.content.main.style.margin = "-1px 0px 0px 0px"),
        ...
        ((this.content.main.style.top = e.top + e.height + window.scrollY + "px"), (this.content.main.style.left = e.left + window.scrollX + "px"), (this.content.main.style.width = e.width + "px"));
    }
  ...
  class o {
    ...
    changeListen(e) {
      (this.listen = e), e && this.observer && this.observer.observe(this.select, { subtree: !0, childList: !0, attributes: !0 }), e || (this.observer && this.observer.disconnect());
    }
    valueChange(e) {
    ...
    observeCall(e) {
      ...
      t && this.onClassChange && this.onClassChange(this.select.className.split(" ")),
        s && this.onDisabledChange && (this.changeListen(!1), this.onDisabledChange(this.select.disabled), this.changeListen(!0)),
        i && this.onOptionsChange && (this.changeListen(!1), this.onOptionsChange(this.getData()), this.changeListen(!0));
    }
    getData() {
      let e = [];
    ...
    getDataFromOptgroup(e) {
      let t = { id: e.id, label: e.label, selectAll: !!e.dataset && "true" === e.dataset.selectall, selectAllText: e.dataset ? e.dataset.selectalltext : "Select all", closable: e.dataset ? e.dataset.closable : "off", options: [] };
    ...
    updateOptions(e) {
      ...
      for (const t of e) t instanceof i && this.select.appendChild(this.createOptgroup(t)), t instanceof n && this.select.appendChild(this.createOption(t));
  ...
  return class {
    constructor(e) {
      ...
      for (const s in e.events) e.events.hasOwnProperty(s) && (-1 !== i.indexOf(s) ? (this.events[s] = t(e.events[s], 100)) : (this.events[s] = e.events[s]));
      (this.settings.disabled = (null === (s = e.settings) || void 0 === s ? void 0 : s.disabled) ? e.settings.disabled : this.selectEl.disabled),
      ...
      h ? this.render.main.main.setAttribute("aria-label", h) : r && this.render.main.main.setAttribute("aria-labelledby", r),
    ...
    setSelected(e, t = !0) {
      ...
      this.select.updateOptions(n),
        ...
        "" !== this.render.content.search.input.value ? this.search(this.render.content.search.input.value) : this.render.renderOptions(n),
        t && this.events.afterChange && !s(i, this.store.getSelected()) && this.events.afterChange(this.store.getSelectedOptions());
    }
    addOption(e) {
      const t = this.store.getSelected();
