...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    script.id = scriptId;
    script.src = "/assets/js/main.js"; // Replace with your script's path
    script.async = true;
  ...
  return (
    <>
      <footer className="et-footer bg-etBlack relative z-[1] before:absolute before:-z-[1] before:inset-0 before:opacity-30 before:mix-blend-overlay text-white">
        <div className="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
          <div className="et-footer-top pt-[130px] xl:pt-[80px] pb-[60px]">
            <div className="bg-etBlue py-[35px] px-[40px] xl:px-[30px] rounded-[20px] mb-[60px] overflow-hidden relative z-[1] flex lg:flex-wrap justify-between lg:justify-center xs:justify-start items-center gap-[20px] before:absolute before:-z-[1] before:inset-0 before:bg-cover before:bg-no-repeat before:bg-center before:opacity-40 before:mix-blend-multiply">
              <div className="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                ...
                <div>
                  ...
                  <h5 className="font-medium text-[20px]">
                    LT-2A NTU, 50 Nanyang Ave, Singapore, 639798
                  </h5>
                </div>
              </div>
              ...
              <div className="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                ...
                <div>
                  ...
                  <h5 className="font-medium text-[20px]">
                    <Link href="mailto:info@eventdex.com">
                      info@eventdex.com
                    </Link>
                  </h5>
                </div>
              ...
              <div className="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                ...
                <div>
                  ...
                  <h5 className="font-medium text-[20px]">
                    <Link href="tel:88012365499">+65 1234 5678</Link>
                  </h5>
                </div>
              </div>
            </div>
            ...
            <div className="flex md:flex-wrap xs:w-full gap-x-[65px] xxl:gap-x-[45px] xl:gap-[30px] gap-y-[25px] justify-between md:justify-center xxs:justify-start">
              <div className="et-footer-about max-w-[295px] lg:max-w-none md:max-w-[300px] xs:max-w-full">
                ...
                <p className="font-light text-[#f2f2f2] text-[16px] mb-[25px]">
                  EventDex is your trusted partner for decentralized event
                  ticketing, ensuring secure and transparent transactions for
                ...
                <div className="et-socials flex gap-[10px] text-[14px] *:border *:border-[#9EAACB] *:text-[#9EAACB] *:w-[40px] *:aspect-square *:shrink-0 *:inline-flex *:items-center *:justify-center *:rounded-full">
                  <Link
                    href="#"
                    className="hover:text-white hover:bg-etBlue hover:border-etBlue"
                  >
              ...
              <div className="et-footer-widget shrink-0 xs:grow">
                ...
                <ul className="space-y-[17px] text-[16px] font-light text-[#f2f2f2]">
                  <li>
                    <Link
                      href="#"
                      className="flex items-center gap-[10px] hover:text-etBlue group"
                    >
                      <span className="icon">
                        <svg
                          width="12"
                        ...
                        >
                          <path
                            ...
                            className="fill-transparent stroke-white group-hover:stroke-etBlue group-hover:fill-etBlue transition"
                          />
                        </svg>
                      </span>
                ...
                <ul className="space-y-[17px] text-[16px] font-light text-[#f2f2f2]">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="txt">About eventdex</span>
                    </Link>
                  </li>
                  <li>
                    <Link
          ...
          <div className="et-footer-bottom border-t border-white/20 py-[34px]">
            <p className="font-light text-[#f2f2f2] text-center text-[16px]">
              &copy; 2024, eventdex All Rights Reserved.
            </p>
          </div>
        </div>
      </footer>
      ...
      ></Script>
      <Script defer src="/assets/vendor/lenis/lenis.min.js"></Script>
      <Script defer src="/assets/vendor/splittype/index.min.js"></Script>
      <Script defer src="/assets/vendor/gsap/gsap.min.js"></Script>
      <Script
        defer
        src="/assets/vendor/gsap/gsap-scroll-trigger.min.js"
      ></Script>

      <Script defer id="dmm-js" src="/assets/js/main.js"></Script>
